...
myPatientInstance.setPatient(name, dob, gender, condition, desc,allergies,physician,aadhar,address,contact ,doa,hospName,bedNo,EHRDate, image, {from: account, gas: 4712387}).then(
        function(){
...
console.log("AES Encrypted desc:"+encDesc);
   myPatientInstance.setDescription(encDesc, {from:account, gas:4712387}).then(
      function(){
...
console.log("Encrypted Image:"+pi.image.call(e.blockNumber));
...
var dob = $("#patientDOB").val();
   ...
   var EHRDate=$("#EHRDate").val();
    var image = $("#inputFileToLoad").val();
updatePatient(name, dob, gender, condition,desc,allergy,phys,aadhar,address,contact,doa,hospName,bedNo,EHRDate);
});
